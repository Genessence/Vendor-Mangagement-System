...
const IndianVendorQuestionnaire = ({ formData, updateFormData, errors }) => {
  // Question 1: Supplier Term of Payment
  ...
  // Question 2: Supplier Payment Method
  ...
  // Question 3: Supplier Delivery Terms
  ...
  // Question 4: Supplier Mode of Delivery
  ...
  // Question 5: Supplier Group
  const supplierGroups = [
    { value: 'CR-AGT', label: 'CR-AGT | Creditors Agents' },
    { value: 'CR-BANK', label: 'CR-BANK | Creditors Bank' },
    { value: 'CR-CAP', label: 'CR-CAP | Creditors Capex' },
    { value: 'CR-CO', label: 'CR-CO | Creditors Consumable' },
    { value: 'CR-EX', label: 'CR-EX | Creditors Expense' },
    { value: 'CR-INT', label: 'CR-INT | Creditors Inter Unit' },
    { value: 'CR-JW', label: 'CR-JW | Creditors Job work' },
    { value: 'CR-KMP', label: 'CR-KMP | Creditors Key Management Persons' },
    { value: 'CR-PK', label: 'CR-PK | Creditors Packing Material' },
    { value: 'CR-RM', label: 'CR-RM | Creditors Raw Material' },
    { value: 'CR-RPT', label: 'CR-RPT | Creditors Related Parties' },
    { value: 'CR-SC', label: 'CR-SC | Creditors Sister Concern' },
    { value: 'CR-STAT', label: 'CR-STAT | Creditors Statutory' },
    { value: 'CR-TPT', label: 'CR-TPT | Creditors Transporter' }
  ];

  // Question 6: Commodity Code
...
export default IndianVendorQuestionnaire; 